...
โปรเจกต์นี้มีการตั้งค่าระบบทดสอบแบบ End-to-End (E2E) ด้วย **Playwright** เพื่อจำลองพฤติกรรมการใช้งานจริงของผู้ใช้ โดยปัจจุบันครอบคลุมการทดสอบ:
- **Import Data**: จำลองการอัปโหลดไฟล์ (CSV/Excel) และตรวจสอบความถูกต้องของการสร้างโครงสร้างหน่วยงาน
- **Export Data**: จำลองการคลิกดาวน์โหลดและตรวจสอบไฟล์ที่ระบบส่งออก

**คำสั่งสำหรับการรัน E2E Test:**
```bash
npx playwright test
```
